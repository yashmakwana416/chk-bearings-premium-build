...
import { CheckCircle2, ShieldCheck, Truck, Factory, MapPin, Phone } from 'lucide-react';
...
export function ProductDetail() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans text-gray-900">
                        ...
                        <div className="bg-white/60 backdrop-blur-xl rounded-[2rem] md:rounded-[2.5rem] border border-white/20 shadow-2xl shadow-gray-900/5 p-6 md:p-12">
                            ...
                            <div className="flex justify-center mb-5">
                                <div className="inline-flex items-center gap-2 bg-gradient-to-r from-primary/10 to-blue-600/10 text-primary px-5 py-2 rounded-full text-xs font-semibold border border-primary/20 shadow-sm">
                                    ...
                                    <span className="">Premium CHK Quality</span>
                                </div>
                            </div>

                            {/* Main Heading with Custom Font */}
                            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 md:mb-5 leading-[1.2] text-center text-gray-900 tracking-tight">
                                {product.hero.title}
                            </h1>

                            {/* Elegant Subtitle */}
                            <p className="text-base md:text-lg text-gray-600 mb-8 text-center max-w-2xl mx-auto leading-relaxed">
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-8">
                                <Button
                                    size="lg"
                                    className="bg-gradient-to-r from-primary to-blue-600 hover:from-blue-600 hover:to-primary text-white rounded-full px-8 text-sm font-semibold shadow-xl shadow-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/40 hover:-translate-y-1 h-12 min-w-[180px]"
                                >
                                ...
                                <Button
                                    variant="outline"
                                    size="lg"
                                    className="border-2 border-gray-200 text-gray-900 hover:bg-gray-900 hover:text-white hover:border-gray-900 rounded-full px-8 text-sm font-semibold bg-white/80 backdrop-blur-sm transition-all duration-500 hover:shadow-xl hover:-translate-y-1 h-12 min-w-[180px]"
                                >
                            ...
                            <div className="grid grid-cols-3 gap-3 max-w-2xl mx-auto pt-6 border-t border-gray-200/50">
                                <div className="flex flex-col items-center gap-2 p-3 rounded-xl hover:bg-white/60 transition-all duration-300">
                                    ...
                                    <p className="font-semibold text-gray-900 text-xs text-center leading-tight">Certified Quality</p>
                                </div>
                                ...
                                <div className="flex flex-col items-center gap-2 p-3 rounded-xl hover:bg-white/60 transition-all duration-300">
                                    ...
                                    <p className="font-semibold text-gray-900 text-xs text-center leading-tight">Fast Delivery</p>
                                </div>
                                ...
                                <div className="flex flex-col items-center gap-2 p-3 rounded-xl hover:bg-white/60 transition-all duration-300">
                                    ...
                                    <p className="font-semibold text-gray-900 text-xs text-center leading-tight">Ready Stock</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="order-2 lg:order-1">
                            <h2 className="text-4xl font-bold mb-8 text-gray-900 leading-tight">{product.whatIs.title}</h2>
            ...
            <section className="py-16 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900">{product.whyChk.title}</h2>
            ...
            <section className="py-24 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-4xl font-bold mb-16 text-center text-gray-900">{product.applications.title}</h2>
                        ...
                        {product.applications.industries.map((app, index) => (
                            <div key={index} className="bg-white p-10 rounded-[2rem] shadow-sm hover:shadow-xl transition-all duration-300 group hover:-translate-y-2 relative">
                                ...
                                <div className="flex items-center gap-3 mb-6 relative z-10">
                                    ...
                                    <span className="font-bold text-xl text-gray-900">{app.city}</span>
                                </div>
                                <h3 className="font-bold text-2xl mb-4 text-gray-900 group-hover:text-primary transition-colors relative z-10">{app.industry}</h3>
                                <p className="text-lg text-gray-600 leading-relaxed relative z-10">{app.description}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section className="py-24 bg-gray-50">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-4xl font-bold mb-16 text-center text-gray-900">{product.comparison.title}</h2>
                                ...
                                <thead>
                                    <tr>
                                        {product.comparison.headers.map((header, idx) => (
                                            <th key={idx} className="p-6 bg-gray-50/50 text-gray-900 font-bold text-lg border-b border-gray-100">
                                                {header}
                                            </th>
                                        ))}
                                    </tr>
                                    ...
                                    {product.comparison.rows.map((row, rowIdx) => (
                                        <tr key={rowIdx} className="border-b border-gray-50 hover:bg-blue-50/30 transition-colors last:border-0">
                                            {row.map((cell, cellIdx) => (
                                                <td key={cellIdx} className={`p-6 text-lg ${cellIdx === 0 ? 'font-bold text-gray-900' : 'text-gray-600'}`}>
                                                    {cell}
                                                </td>
                                            ))}
                                        </tr>
            ...
            <section className="py-24 bg-gray-50">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-4xl font-bold mb-16 text-center text-gray-900">{product.faq.title}</h2>
                    <div className="space-y-6">
                        {product.faq.items.map((item, index) => (
                            <div key={index} className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow">
                                <h3 className="font-bold text-xl text-gray-900 mb-4 flex items-start gap-4">
                                    <div className="bg-primary/10 p-1.5 rounded-lg mt-0.5">
                                        <span className="text-primary font-bold text-sm block leading-none">?</span>
                                    </div>
                                    {item.question}
                                </h3>
                                <p className="text-lg text-gray-600 pl-12 leading-relaxed">{item.answer}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section className="py-20 md:py-32 bg-gray-50 border-t border-gray-200">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-3xl md:text-4xl md:text-5xl font-bold mb-6 md:mb-8 text-gray-900 tracking-tight">Ready to Order Premium Bearings?</h2>
                    <p className="text-lg md:text-xl md:text-2xl text-gray-600 mb-8 md:mb-12 max-w-3xl mx-auto leading-relaxed">
                        Contact us today for the best prices and instant delivery in Rajkot, Morbi, and Surat.
                    </p>
                    <div className="flex flex-col sm:flex-row justify-center gap-4 md:gap-6">
                        <Button size="lg" className="bg-primary hover:bg-blue-700 text-white rounded-full px-12 h-16 text-xl font-bold shadow-lg shadow-blue-500/20 transition-all hover:-translate-y-1">
                            <Phone className="mr-3 w-6 h-6" />
                            Call Now
                        </Button>
                        <Button variant="outline" size="lg" className="border-gray-300 text-gray-900 hover:bg-gray-100 hover:text-primary rounded-full px-12 h-16 text-xl font-medium bg-white shadow-sm transition-all hover:-translate-y-1">
                            Request Quote
                        </Button>
                    </div>
                </div>
